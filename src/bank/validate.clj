...
;;valida a transacao seguindo requisitos definidos pelo exercicio
(defn validate-transaction [json available-limit last-time]
    ...
    (if (= account-active true)
        (do 
            ...
            (if (or (nil? last-time) (t/after? t-time last-time ) (t/equal? t-time last-time )) ;verifica se existe last-time e incosistencia de cronologia
                (do
                    (def chrono-accepted true)
                    (def account-last-time t-time) ;define o account-last-time como sendo o valor da ultima transacao
                    ...
                    ;verifica se a frequencia esta alta                
                    (if (< freq 3)
    ...
    (cond
        ...
        (= chrono-accepted false) "chronology-error"                 
